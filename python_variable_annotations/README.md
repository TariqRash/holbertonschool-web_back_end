...
## Description
This project covers type annotations in Python 3. It explores how to use type annotations to specify function signatures and variable types, duck typing, and how to validate code with mypy.
...
- All files use the pycodestyle style (version 2.5)
...
| 10 | `100-safe_first_element.py` | Duck typing - first element of a sequence |
| 11 | `101-safely_get_value.py` | More involved type annotations |
| 12 | `102-type_checking.py` | Type Checking |
